...
import com.todolist2.demo.domain.TodoRepository;
import com.todolist2.demo.domain.User;
import com.todolist2.demo.domain.UserRepository;
...
public class TodoService {
    ...
    // 본인 확인 로직. Todo 객체 내의 User와 요청을 보내는게 동일한지 확인
